...
using PermissionBl.Validators.Models;
using PermissionModels.Entities.Base;
using PermissionModels.Repositories;

namespace PermissionBl.Services
{
    public interface IBaseService<TEntity, TEntityDto> where TEntity : class, IBaseEntity
    ...
    public class BaseService<TEntity, TEntityDto> : IBaseService<TEntity, TEntityDto> where TEntity : class, IBaseEntity
      where TEntityDto : class, IBaseEntityDto
    {
